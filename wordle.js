...
row1.addEventListener('change', (event) => {
    const row = '1';
...
row3.addEventListener('change', (event) => {
    const row = '3';
    let guess = getWordleGuess(row);
...
row4.addEventListener('change', (event) => {
    const row = '4';
    let guess = getWordleGuess(row);
...
row5.addEventListener('change', (event) => {
    const row = '5';
    let guess = getWordleGuess(row);
...
row6.addEventListener('change', (event) => {
    const row = '6';
    let guess = getWordleGuess(row);
