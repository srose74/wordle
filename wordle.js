    ...
    for (let i = 0;i<wordleWord.length;i++){
        if (guess[i].toLowerCase() === wordleWord[i] ){
            ...
            result[i].inPosition = true;
                ...
                //only turn the letter yellow if it's not already a green letter
                result[i].letter = guess[i].toUpperCase();
